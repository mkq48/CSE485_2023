            ...
            <div class="col-sm">
                ...
                <form action="process_add_article.php" method="post">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatName" value = "2012/7/23">
                    </div>
