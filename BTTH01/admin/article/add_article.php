...
<body>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <h3 class="text-center text-uppercase fw-bold">Thêm mới bài hát</h3>
                <form action="process_add_article.php" method="post">

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArtName">Mã bài viết</span>
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArtName">Mã thể loại</span>
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArtName">Mã tác giả</span>
